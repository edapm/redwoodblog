...
import { Form, TextField, TextAreaField, Submit, FieldError, Label, FormError, useForm } from '@redwoodjs/forms'
  ...
  return (
    <>
      ...
      <Form onSubmit={onSubmit} config={{ mode: 'onBlur' }} error={error} formMethods={formMethods}>
        ...
        <TextField name="email" validation={{ required: true, pattern: {value: /[^@]+@[^.]+\..+/,}, message: 'Please enter a valid email address', }} errorClassName="error" />
